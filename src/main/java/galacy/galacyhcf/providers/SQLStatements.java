...
public class SQLStatements {
    ...
    public static final String createFactionsTable = "CREATE TABLE IF NOT EXISTS `factions` (`id` int UNIQUE PRIMARY KEY AUTO_INCREMENT,`created_at` datetime,`updated_at` datetime,`name` varchar(255),`balance` int,`dtr` int,`home` varchar(255),`leader_id` varchar(255));";
