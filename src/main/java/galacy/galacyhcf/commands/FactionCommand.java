                        ...
                        if (((GPlayer) sender).balance < 1)
                            ...
                            if (args.length == 1)
                                ...
                                if (((GPlayer) sender).balance < newBalance)
                                    ...
                                    sender.sendMessage(Utils.prefix + TextFormat.GREEN + "You've successfully put " + TextFormat.YELLOW + faction.balance + "$ " + TextFormat.GREEN + "in your faction's balance.");
                                }
                            }
                        }
                    }
                        ...
                        if (!faction.leaderId.equals(((GPlayer) sender).xuid))
                            ...
                            if (args.length == 1)
                                ...
                                if (faction.balance < newBalance)
                                    ...
                                    faction.updateBalance(faction.balance - newBalance);
                                    ((GPlayer) sender).updateBalance(((GPlayer) sender).balance + newBalance);
                                    sender.sendMessage(Utils.prefix + TextFormat.GREEN + "You've successfully withdrawn " + TextFormat.YELLOW + faction.balance + "$ " + TextFormat.GREEN + "from your faction's balance.");
                                }
                            }
                        }
                    }
